...
* **Nonlinear Dynamics & Chaos:** Implementation of numerical tools to model nonlinear perturbations, including the study of phase space trajectories and **Poincaré sections**.
...
* `src/`: Directory containing the numerical solvers and scripts (MATLAB/Python) used to simulate the dynamics, solve the ODE systems (`ode45` framework), and plot the Poincaré sections.
...
* **Cesc Barrera** – Engineering Physics Undergraduate Student, Universitat Politècnica de Catalunya (UPC).
* *Co-authored with Ernest J. Redolat (April 2026).*
